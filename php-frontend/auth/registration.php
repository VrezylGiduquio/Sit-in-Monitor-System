      ...
      <div class="auth-layout">
        <div class="auth-side-panel">
          <div class="auth-side-top">
            <div class="auth-side-kicker"><i class="fa-solid fa-user-plus"></i> New Account</div>
            <h2 class="auth-side-title">Create Your <span>Portal</span></h2>
            <p class="auth-side-text">Set up your CCS account once, then handle reservations, software visibility, and sit-in records from one place.</p>
            <div class="auth-side-stats">
              <div class="auth-side-stat">
                <strong>6</strong>
                <span>Labs Listed</span>
              </div>
              <div class="auth-side-stat">
                <strong>Easy</strong>
          ...
          <div class="auth-side-bottom">
            <div class="auth-side-note">
              <p>Register with your school details so the system can prepare your dashboard, session history, and reservation access.</p>
            </div>
          </div>
        </div>
        <div class="auth-panel">
          <div class="auth-panel-inner" style="width:min(100%,620px)">
            <a href="login.php" class="btn-back">
              <i class="fa-solid fa-arrow-left"></i> Back
            </a>

            <div class="hero-badge"><i class="fa-solid fa-id-card"></i> Student Registration</div>
            <h2 class="auth-title">Create Account</h2>
            <p class="auth-subtitle">Join the CCS Sit-in Monitoring System to get started.</p>

            <form id="registerForm" class="auth-form auth-grid" novalidate onsubmit="return false;">
            ...
            <div class="auth-helper-row">
              <span class="auth-mini-note"><i class="fa-solid fa-bolt"></i> Complete your school profile once</span>
            </div>
